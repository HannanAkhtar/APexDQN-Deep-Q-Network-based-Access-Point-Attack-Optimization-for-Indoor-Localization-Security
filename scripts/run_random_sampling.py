...
from search_strategies.algorithms import run_random_sampling
from search_strategies.config import RESULTS_DIR
from search_strategies.utils.io import ensure_dir


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Run the random sampling benchmark.')
    ...
    parser.add_argument('--output-path', default=str(RESULTS_DIR / 'random_sampling_results.csv'))
